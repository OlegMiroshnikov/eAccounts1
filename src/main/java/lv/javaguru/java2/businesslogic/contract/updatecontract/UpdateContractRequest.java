...
public class UpdateContractRequest {
    ...
    public UpdateContractRequest(Integer id, Integer companyId, Integer clientId, String number, Date dateSign, Date dateBegin, Date dateEnd, Integer dayToSendAccount, Integer countDaysToSendReminder, Integer status) {
        this.id = id;
